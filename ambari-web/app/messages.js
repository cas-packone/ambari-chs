...
Em.I18n.translations = {
 ...
 'admin.stackVersions.version.upgrade.alertsWarning': 'Cluster alerts will still be visible and recorded in Ambari but notifications (such as Email and SNMP) will be suppressed during the upgrade.',
  ...
  'services.nothingToAdd':'没有什么要补充',//Nothing to add
  ...
  'services.service.summary.PhoenixServersLIVE':'Phoenix 查询 服务 现场',
  ...
  'services.service.summary.unknown':'不知道的',//
  ...
  'services.service.summary.ranger.plugin.loadingStatus': 'Loading status...',//Loading status
  ...
  'alerts.actions.manage_alert_groups_popup.addButton':'创建简报组',//Create Alert Group
  ...
  'hosts.filters.clearSelection': '明确的选择',//clear selection
  ...
  'hosts.host.metrics.memory.displayNames.mem_free':'游离',//Free
  'hosts.host.metrics.memory.displayNames.mem_cached':'高速缓存',//Cached
  'hosts.host.metrics.network':'网关使用率',//Network Usage
  'hosts.host.metrics.network.displayNames.pkts_out':'包出',//Packets Out
  ...
  'hosts.host.details.setRackId':'一套机架',//Set Rack
  ...
  'hosts.host.regionserver.decommission.batch3':'停止使用RegionServer - 将漏模式关闭',//Decommission RegionServer - Turn drain mode off
  ...
  'hosts.host.healthStatus.mastersDown':"以下组件下降:\n",//The following master components are down
  'hosts.host.healthStatus.slavesDown':"下面从部件下降:\n",//The following slave components are down
  'hosts.host.healthStatus.allUp':'所有组件为',//All components are up
  'hosts.host.healthStatusCategory.green': "正常",//Healthy
  'hosts.host.healthStatusCategory.red': "主向下",//Master Down
  'hosts.host.healthStatusCategory.orange': "从下",//Slave Down
  ...
  'charts.heatmap.label.invalidData' :'数据无效',//Invalid data
  ...
  'dashboard.services.hdfs.datanode.status.tooltip.live': '这是datanode的数量从NameNode生活报道。即使一个DataNode的过程,然后会看到死亡的状态.如果DataNode与NameNode没有按预期的进行通信。这可能是由于情况如网络问题或挂起DataNode由于过度垃圾收集的过程.',
